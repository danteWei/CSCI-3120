...
# 1 "/Library/Developer/CommandLineTools/usr/bin/../lib/clang/5.1/include/stdint.h" 1 3 4
# 64 "/Library/Developer/CommandLineTools/usr/bin/../lib/clang/5.1/include/stdint.h" 3 4
...
# 65 "/Library/Developer/CommandLineTools/usr/bin/../lib/clang/5.1/include/stdint.h" 2 3 4
...
void installHandlerInd(int *alrmSuc, int *urs1Suc, int *hupSuc, int *breakSuc){
 ...
 if(signal(14, alarm_bells) == ((void (*)(int))-1)){
  printf("%salarm handler!\n", errInstallMsg);
  *alrmSuc=-1;
 }
 if(signal(30, printSysState) == ((void (*)(int))-1)){
  printf("%surs1 handler!\n", errInstallMsg);
  *urs1Suc=-1;
 }
 if(signal(1, reConfig) == ((void (*)(int))-1)){
  printf("%shup handler!\n", errInstallMsg);
  *hupSuc=-1;
 }
 if(signal(2, exitAll) == ((void (*)(int))-1)){
...
void installHandlerCol(int *return_code){
 if(signal(14, alarm_bells) == ((void (*)(int))-1) || signal(30, printSysState) == ((void (*)(int))-1) || signal(1, reConfig) == ((void (*)(int))-1) || signal(2, exitAll) == ((void (*)(int))-1)){
...
int main(int argc, char **argv){
 ...
 char timerLine[(81)];
 if(fgets(timerLine, (81)-1, fp) != ((void *)0))
  TIMER=timerLine[6]-'0';
 ...
 while(1){
  ...
  if(sscanf(line, "%s %d %d", name, &lifeTime, &runTime) == 3){
   ...
   if(pcb != ((void *)0)){
    __builtin___strncpy_chk (pcb->name, name, (21)-1, __builtin_object_size (pcb->name, 2 > 1 ? 1 : 0));
